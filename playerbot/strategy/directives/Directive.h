...
namespace ai
{
    ...
    struct Directive
    {
        ...
        std::string pulling;              // tank pull pacing: hold|normal|fast|steer — stored sticky on "pull policy"
        bool comeToMaster = false;        // one-shot spatial recall: move to master until 3D proximity + LoS
