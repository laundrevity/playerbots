...
namespace ai
{
    ...
    public:
        ValueContext()
        {
            ...
            creators["pull policy"] = [](PlayerbotAI* ai) { return (UntypedValue*)new PullPolicyValue(ai); };
            creators["come to master until"] = [](PlayerbotAI* ai) { return (UntypedValue*)new ComeToMasterUntilValue(ai); };
